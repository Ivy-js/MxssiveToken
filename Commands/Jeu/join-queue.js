...
module.exports = new Command({
  ...
  async run(client, message, args) {
    ...
    if(!await client.db.get(`users.${userId}`)){
      let error = new Discord.MessageEmbed()    
      .setDescription(`
Vous n'avez pas créer de compte Mxssive. 
Pour en créer un : </start:1206717244776652843>      
      `)
      .setColor(client.color);
      
      return message.reply({embeds: [error], ephemeral:true});
    } else {
